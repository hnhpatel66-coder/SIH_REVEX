...
function vehicleRow(vehicle) {
  ...
  // An approved vehicle whose owner set a future "available from" date is
  // invisible on the renter portal until then. Flag it so an admin approving a
  // listing is not left wondering why it does not appear for rent.
